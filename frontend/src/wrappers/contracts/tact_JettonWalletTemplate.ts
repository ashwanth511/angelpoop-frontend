...
function dictValueParserJettonFactory$Data(): DictionaryValue<JettonFactory$Data> {
 ...
 type JettonWalletTemplate_init_args = {
    $$type: 'JettonWalletTemplate_init_args';
    master: Address;
    owner: Address;
}

function initJettonWalletTemplate_init_args(src: JettonWalletTemplate_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.master);
        b_0.storeAddress(src.owner);
...
async function JettonWalletTemplate_init(master: Address, owner: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initJettonWalletTemplate_init_args({ $$type: 'JettonWalletTemplate_init_args', master, owner })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const JettonWalletTemplate_errors: { [key: number]: { message: string } } = {
...
const JettonWalletTemplate_types: ABIType[] = [
...
const JettonWalletTemplate_getters: ABIGetter[] = [
...
export const JettonWalletTemplate_getterMapping: { [key: string]: string } = {
    'get_wallet_data': 'getGetWalletData',
    'tonBalance': 'getTonBalance',
    'staticTax': 'getStaticTax',
}

const JettonWalletTemplate_receivers: ABIReceiver[] = [
...
export class JettonWalletTemplate implements Contract {
    
    static async init(master: Address, owner: Address) {
        return await JettonWalletTemplate_init(master, owner);
    }
    
    static async fromInit(master: Address, owner: Address) {
        const init = await JettonWalletTemplate_init(master, owner);
        const address = contractAddress(0, init);
        return new JettonWalletTemplate(address, init);
    }
    
    static fromAddress(address: Address) {
        return new JettonWalletTemplate(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  JettonWalletTemplate_types,
        getters: JettonWalletTemplate_getters,
        receivers: JettonWalletTemplate_receivers,
        errors: JettonWalletTemplate_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: TokenTransfer | TokenTransferInternal | Burn | Excesses | 'withdraw' | SetStaticTax | Deploy) {
